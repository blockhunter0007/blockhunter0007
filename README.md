...
## Projects
  ...
  ### Finished:
   ...
   - **memory lib**
     - A memory lib with patternscanning ect, aiming to be faster and more efficient than pymem, the pattern_scan_all is already faster due to regex pattern scanning.
